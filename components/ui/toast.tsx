...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed top-4 right-4 flex flex-col gap-2 w-[390px] max-w-[100vw] m-0 z-[100] outline-none',
      className
    )}
    {...props}
  />
